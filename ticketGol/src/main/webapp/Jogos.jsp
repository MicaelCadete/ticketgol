...
<body>
  ...
  <section id="jogos">
    <div class="container">
      ...
      <div class="card-pt1">
        <!-- Card 1 -->
    <c:forEach var="evento" items="${dados}">
        <div class="card">
          <div class="image-box"></div>
          <!-- Conteúdo do card -->
          <div class="content">
            <!-- Imagens e informações do jogo -->
            <img src="Jogos/img/img-saopaulo.png" />
            <h1>X</h1>
            <img src="Jogos/img/img-novorizontino.png" class="img2" />
            <h2>${evento.nomeEvento}</h2>
            <p>${evento.data}</p>
            <p>Estádio: ${evento.local}</p>
            <!-- Botão de comprar -->
            <button class="btn-comprar">
              <a href="Login.html" class="btn-comprar">
  ...
  <section id="informacoes">
    <footer class="footer-distributed">
      ...
      <div class="footer-center">
        ...
        <div>
          <img src="Home/img/img-iconeMaps.png" class="icone-info">
          <p><span><b>São Paulo, SP</b></span></p>
        </div>
        <div>
          <img src="Home/img/img-iconeTelefone.png" class="icone-info">
          <p>+55 (11) 93354-8219</p>
        </div>
        <div>
          <img src="Home/img/img-iconeEmail.png" class="icone-info">
      ...
      <div class="footer-right">
        <p class="footer-company-about">
          <span>Sobre Nós</span>
          <strong>TicketGol - </strong>Somos a sua porta de entrada para a emoção e a paixão dos grandes jogos. Na nossa
